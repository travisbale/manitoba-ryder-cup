<template>
  <tr class="border-b border-grey-400 text-center">
    <td class="px-4 py-2 border-r border-grey-300">
      {{ number }}
    </td>
...
export default {
  ...
  computed: {
    redColorClass() {
      return {
        'bg-red-400': this.redScore < this.blueScore,
      };
    },

    blueColorClass() {
      return {
        'bg-blue-400': this.blueScore < this.redScore,
      };
    },
